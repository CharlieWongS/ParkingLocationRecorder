   ...
   var body: some View {
       ...
       ZStack {
           ...
           .alert("Copied to clipboard and focused on map", isPresented: $showCopiedAlert) {
               ...
               Button("Open in Apple Maps") {lm.openInAppleMaps()}
           }
           .onAppear {
           ...
           VStack {
               ...
               HStack {
                   delteAllButton
                       .padding(.leading)
                       .padding(.bottom)
                       .alert("Detele All?", isPresented: $showDeleteAllAlert) {
                           Button("Delete All", role: .destructive) {lm.deleteAllHistories()}
...
extension HistoryListView {
    ...
    private var delteAllButton: some View {
        Button(role: .destructive){
